...
import cn.sitedev.domain.associate.AuthorAndBlog;
import cn.sitedev.domain.associate.BlogAndAuthor;
import cn.sitedev.domain.associate.BlogAndComment;
import cn.sitedev.mapper.BlogMapper;
import cn.sitedev.mapper.BlogMapperExt;
...
public class MyBatisTest {
    ...
    public void testStatement() throws IOException {
        ...
        try {
            Blog blog = (Blog) session.selectOne("cn.sitedev.mapper.BlogMapper.selectBlogById", 1);
