...
public class JdbcTest {
    ...
    public void testJdbc() throws IOException {
        ...
        try {
            ...
            // 打开连接
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/sitedev-mybatis", "root", "root");
    ...
    public void testJdbcBatch() throws IOException {
        ...
        try {
            ...
            // 打开连接
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mybatis?useUnicode=true&characterEncoding"
                    + "=utf-8&rewriteBatchedStatements=true", "root", "root");
